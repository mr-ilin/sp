...
// семантические подпрограмммы
    ...
    void make_links() {
        tSemPointer tmp[] = {0, &tBC::p01, &tBC::p02, &tBC::p03, &tBC::p04, &tBC::p05, &tBC::p06, &tBC::p07, &tBC::p08,
                             &tBC::p09, &tBC::p10, &tBC::p11, &tBC::p12, &tBC::p13, &tBC::p14, &tBC::p15, &tBC::p16,
                             &tBC::p17, &tBC::p18, &tBC::p19, &tBC::p20, &tBC::p21, &tBC::p22, &tBC::p23, &tBC::p24,
                             &tBC::p25, &tBC::p26, &tBC::p27, &tBC::p28, &tBC::p29, &tBC::p30, &tBC::p31, &tBC::p32,
                             &tBC::p33, &tBC::p34, &tBC::p35, &tBC::p36, &tBC::p37, &tBC::p38, &tBC::p39, &tBC::p40,
                             &tBC::p41, &tBC::p42, &tBC::p43, &tBC::p44, &tBC::p45, &tBC::p46, &tBC::p47, &tBC::p48,
                             &tBC::p49, &tBC::p50, &tBC::p51, &tBC::p52, &tBC::p53, &tBC::p54, &tBC::p55, &tBC::p56,
                             &tBC::p57, &tBC::p58, &tBC::p59, &tBC::p60, &tBC::p61, &tBC::p62, &tBC::p63, &tBC::p64,
                             &tBC::p65, &tBC::p66, &tBC::p67, &tBC::p68, &tBC::p69, &tBC::p70, &tBC::p71, &tBC::p72,
                             &tBC::p73, &tBC::p74, &tBC::p75, &tBC::p76, &tBC::p77, &tBC::p78, &tBC::p79, &tBC::p80,
                             &tBC::p81, &tBC::p82, &tBC::p83, &tBC::p84, &tBC::p85, &tBC::p86, &tBC::p87, &tBC::p88,
                             &tBC::p89, &tBC::p90, &tBC::p91, &tBC::p92, &tBC::p93, &tBC::p94, &tBC::p95, &tBC::p96,
                             &tBC::p97, &tBC::p98, &tBC::p99, &tBC::p100, &tBC::p101, &tBC::p102, &tBC::p103,
                             &tBC::p104, &tBC::p105, &tBC::p106, &tBC::p107, &tBC::p108, &tBC::p109, &tBC::p110
        };
        links =
